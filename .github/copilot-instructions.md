...
## Technologies:
- **PostgreSQL (Supabase)**: For relational database management.
...
2. Update relevant documentation files (e.g., `documentation/`) when making changes that affect the system's behavior.
