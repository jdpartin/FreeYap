...
const serverUrl = 'http://localhost:3000'; // Adjust this to your server URL
...
function joinQueue(socket: any, mode: string, topics: string[], ipHash: string) 
{
    return fetch(`${serverUrl}/api/matchmaking/join-queue`, 
    {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
